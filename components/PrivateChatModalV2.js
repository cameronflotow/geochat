...
export default function PrivateChatModalV2({ isOpen, onClose, conversationId, otherUser, currentUserId }) {
    ...
    return (
        <div className="fixed inset-0 z-[2100] flex items-center justify-center bg-black/80 backdrop-blur-md p-4">
            <div className="glass-panel w-full max-w-sm p-4 relative max-h-[80vh] h-[70vh] flex flex-col animate-in fade-in zoom-in duration-200 border-4 border-red-500">
                ...
                <div className="flex items-center justify-between border-b border-white/10 pb-3 mb-3 shrink-0">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <span className="text-[10px] text-gray-400 uppercase tracking-wider">Private Chat V2 (Force)</span>
                        </div>
                    </div>
